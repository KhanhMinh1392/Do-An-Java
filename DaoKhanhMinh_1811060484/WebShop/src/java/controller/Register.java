...
//        processRequest(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (manv == null || tennv == null || sdtnv == null || email == null 
                || taikhoan == null || matkhau == null || manv.length() == 0 || tennv.length() == 0 || email.length() == 0 || sdtnv.length() == 0 || taikhoan.length() == 0 || matkhau.length() == 0) {
            errorString = "Cac truong khong duoc de trong";
        } else {
            try {
                nvd = new NhanVienDao();
